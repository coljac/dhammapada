...
build_linux_arm64:
	...
	GOOS=linux GOARCH=arm64 go build -o $(LINUX_ARM64_DIR)/$(APP_NAME)
...
all: build_macos build_linux_amd64 build_linux_arm64 build_windows

# Clean up the build artifacts
clean:
	rm -rf $(OUTPUT_DIR)

.PHONY: all build_macos build_linux_amd64 build_linux_arm64 build_windows clean